export const smallInput = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const puzzleInput = `faded plum bags contain 5 wavy cyan bags.
