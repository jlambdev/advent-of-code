export const sampleOne = `-L|F7
7S-7|
L|7||
-L-J|
L|-JF`;

export const sampleTwo = `7-F7-
.FJ|7
SJLL7
|F--J
LJ.LJ`;

export const puzzleInput = `.7--77|.|-|77F|.J.|.FF.J-|7F--7F7.J----7FJ77J..F77-77-F.F|7-|F-.|F777FF7|-.-|-7|..FFL---L7-7FL7L-|-77.FL-7FF-7FJF|-7|7-FF|-|.J-FLJ7.F7.F7--L
